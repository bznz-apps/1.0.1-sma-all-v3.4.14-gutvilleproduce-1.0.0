            ...
            <div id="sidebar-left">
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        <!--
                          Sample Code for adding new Menu Item to the SideBar
                          Menu
                          1 -
                          2 - Need to setup, new controller and new page
                          3 - Search xxxxx library for correct icon class
                          4 -
                        -->
                        ...
                        <li class=""> <!-- 1 -->
                            <a href="<?= admin_url('sample1') ?>"> <!-- 2 -->
                                ...
                                <span class="text"> <?= lang('dashboard'); ?></span> <!-- 4 -->
                            </a>
                        </li>

                        <!-- SIDEBAR - Test Menu Item with SubMenus ----------->
                        <!--
                          Sample Code for adding new Menu Item with SubMenus to
                          the SideBar Menu
                        -->
